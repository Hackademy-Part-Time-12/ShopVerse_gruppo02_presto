                    ...
                    <div class="product-grid mx-1 col-md-5 my-2">
                        ...
                        <div class="product-content mt-1 ">
                            ...
                            <div class="row justify-content-center">
                                <p class="btn-link col-3"><a href="{{route('advertisement.edit',$annunci)}}" class="text-warning fw-bold ">Modifica</a></p>
                                <p class="btn-link col-3"><a href="" class="text-danger fw-bold ">Elimina</a></p>
