        ...
        <div class="col-12 row my-5">
            ...
            @if (session('delete'))
                <div class="alert alert-danger">
                    <p class="text-black fw-bold ">{{ session('delete') }}</p>
                </div>
            @endif
                    ...
                    <div class="product-grid mx-1 col-md-3 my-2">
                        ...
                        <div class="product-content mt-1 ">
                            ...
                            <div class="row justify-content-center">
                                <p class="btn-link col"><a href="{{ route('advertisement.edit', $annunci) }}"
                                        class="text-warning fw-bold ">Modifica</a></p>
                                <p class="btn-link col"><a href="{{ route('advertisement.delete', $annunci) }}"
                                        class="text-danger fw-bold ">Elimina</a></p>
