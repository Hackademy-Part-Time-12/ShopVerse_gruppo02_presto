...
{{-- <script type="module">
    import {
        cambiabackground
    } from './resources/cardcategory.js'
</script> --}}
                ...
                switch (nomecategoria.innerHTML) {
                    case 'Informatica':
                        categoria.style.backgroundImage =
                            "url('https://i.pinimg.com/originals/4e/d9/55/4ed9551939c4af7745227b184dce4fc6.jpg')";
                        break;
                    ...
                    case 'Telefoni':
                        categoria.style.backgroundImage =
                            "url('https://www.yeppon.it/guide-acquisti/wp-content/uploads/2023/05/shutterstock_2105590691-760x460.jpg')";
                        break;
                    ...
                    case 'Sport':
                        categoria.style.backgroundImage =
                            "url('https://sportstymecamps.com/wp-content/uploads/2016/06/AdobeStock_55910509.jpeg')";
                        break;

                    case 'Tempo libero':
                        categoria.style.backgroundImage =
                            "url('https://www.medicusinfo.eu/wp-content/uploads/2018/04/tempo-libero-cat.jpg')";
                        break;
