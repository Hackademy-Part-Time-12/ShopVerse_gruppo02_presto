    ...
    <div class="row text-center w-100 align-items-center g-0">
        ...
        <div class="col-lg-5 col-md-5 d-none d-lg-block d-md-block d-xs-none me-auto">
            <div class="d-flex justify-content-around border-top border-bottom border-dark linea">
                ...
                <div class="customLink d-flex align-items-center">
                    <!-- Aggiunto il div con la classe 'round' per l'immagine dell'utente -->
                    <div class="round img-fluid"><img src="/Media/user.png" alt=""></div>
                    <!-- Aggiunto il testo "Benvenuto Utente" -->
                    <a class="d-inline-block p-3" href="#">Benvenuto Utente</a>
                </div>
            </div>
        </div>
