    ...
    <div class="row text-center w-100 align-items-center g-0">
        ...
        <div class="col-lg-5 col-md-5 d-none d-lg-block d-md-block d-xs-none ms-auto shadow contenitore">
            ...
            <ul class="d-flex justify-content-around mt-3 linea">
                ...
                <li class="customLink dropdown">
                    <a class="d-inline-block p-3 dropdown-toggle " href="#" id="categoriesDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
        ...
        <div class="col-lg-5 col-md-5 d-none d-lg-block d-md-block d-xs-none me-auto shadow  contenitore2">
            ...
            <ul class="d-flex justify-content-around mt-3 linea">
                ...
                <li class="customLink ms-2"><a class="d-inline-block p-3" href="{{ route('become.revisor') }}">Lavora con noi</a>
                </li>
                ...
                <li class="customLink dropdown  ">
                    ...
                    <a class="d-inline-block p-3 dropdown-toggle navbarColor" href="#" id="navbarDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
...
<nav class="container-fluid w-100 pt-0 mt-0 navbar z-3" role="navigation">
    ...
    <div class="row text-center w-100 align-items-center g-0">
        ...
        <div class="col-lg-5 col-md-5 d-none d-lg-block d-md-block d-xs-none ms-auto shadow contenitore">
            ...
            <ul class="d-flex justify-content-around mt-3 linea">
                <li class="customLink"><a class="d-inline-block p-3" href="{{ Route('home') }}"><b class="navbarColor">Home</b> </a></li>
                <li class="customLink"><a class="d-inline-block p-3" href="{{ Route('advertisement.index') }}"><b class="navbarColor">Annunci</b> </a>
                </li>
                <li class="customLink dropdown">
                    <a class="d-inline-block p-3 dropdown-toggle " href="#" id="categoriesDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <b class="navbarColor">Categorie</b></a>
        ...
        <div class="col-lg-5 col-md-5 d-none d-lg-block d-md-block d-xs-none me-auto shadow  contenitore2">
            ...
            <ul class="d-flex justify-content-around mt-3 linea">
                ...
                <li class="customLink ms-2"><a class="d-inline-block p-3" href="{{ route('become.revisor') }}">Lavora</a>
                </li>
