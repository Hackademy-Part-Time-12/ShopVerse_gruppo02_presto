<x-layout>
    ...
    <section class=" col-8 container-fluid my-5 pt-3">
        <div class="row justify-content-center bg-form  pt-5  ">
            ...
            <div class="container-fluid col-7 my-5">
                ...
                <form method="POST" action="{{-- {{route('advertisement.update',$advertisement) }} --}}">
                    @csrf
                    @method('PUT' )
                    <div class="mb-3 row ">
                        <label for=" text" class="second">Titolo annuncio</label>
                        <input type="text" name="title" value="{{$advertisement->title }}" id="title"
